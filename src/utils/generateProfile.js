...
- Total 10 keywords across primary, local, and longTail groups.`;
  ...
  try {
    ...
    return {
      longDescription: stripStars(parsed.longDescription) || "Description not available.",
      shortDescription: stripStars(parsed.shortDescription) || "Short description not available.",
