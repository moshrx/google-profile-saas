    ...
    <div className="min-h-screen bg-[#FAFBFF] selection:bg-primary-500/10 selection:text-primary-700 overflow-x-hidden">
      ...
      <section className="relative pt-40 sm:pt-40 md:pt-48 pb-12 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center justify-center animate-fade-in-up gap-3 sm:gap-4" style={{ animationDelay: '0.2s' }}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 w-full sm:w-auto">
              ...
              <div className="flex items-center gap-2 sm:gap-0">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 border-white bg-slate-100 flex items-center justify-center overflow-hidden">
                ...
                <div className="flex items-center ml-2 sm:ml-4">
                  ...
                  <span className="ml-2 text-xs sm:text-sm font-bold text-slate-600">500+ Local Businesses</span>
                </div>
              </div>
            </div>
      ...
      <section id="how-it-works" className="py-16 sm:py-24 px-4 sm:px-6 bg-slate-900 text-white relative rounded-3xl sm:rounded-[4rem] mx-4 sm:mx-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 relative">
