export function PrivacyPolicyContent() {
  return (
    <div className="text-sm sm:text-base space-y-5 text-slate-600 leading-relaxed">
      ...
      <p>When you use our Google Profile Kit generator, you enter business information such as your business name, category, address, phone number, website, and a description of your services. This information is transmitted directly to Anthropic's Claude AI to generate your profile kit and is <strong>never stored on our servers</strong>. If you submit your email address to receive your kit or book a consultation, that contact information is sent to us via EmailJS and stored locally in your browser.</p>
      ...
      <ul className="list-disc pl-5 space-y-1">
        <li><strong>Anthropic Claude AI</strong> — your business inputs are processed by Anthropic's API to generate content. See <a href="https://www.anthropic.com/legal/privacy" target="_blank" rel="noopener noreferrer" className="text-primary-600 underline">Anthropic's Privacy Policy</a>.</li>
